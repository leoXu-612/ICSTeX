...
| 对象 | 状态 | 说明 |
| --- | --- | --- |
| 当前源码 | Verified V1 checkpoint GUI synchronized | 2.1.0-beta.2；最新 M4 GUI 源码 `1b1f371` 已推送至 `codex/v1-development`，全套通过且远端哈希核验一致；保留 Beta 远端 `release/2.1`；不是完整 V1 验收或发布 |
