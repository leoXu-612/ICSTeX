...
def main():
    ...
    parser.add_argument("--verbose", action="store_true", help="Name each source test when diagnosing a native test-runner exit")
    ...
    if args.verbose and not args.preflight:
        command.append("-v")
