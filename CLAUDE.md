...
Current app version: **2.1.0-beta.2**
...
5. Read `docs/DECISION_LOG.md` or `docs/ROADMAP.md` only when relevant.

Project memory rules are defined in `docs/MEMORY_MANAGEMENT.md`. Do not restore
duplicated rules or completed-task history to this file.
